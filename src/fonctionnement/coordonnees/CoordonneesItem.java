...
public class CoordonneesItem extends Coordonnees{
    ...
    private static final List<Item> m_items = List.of(
            ...
            new ArmeGuerre("Rapière", new De(1,4), 1, new Substantif("épée longue", new Feminin())),
            new ArmeGuerre("épée longue", new De(1,4), 2, new Substantif("épée longue", new Feminin())),
            new ArmeCourante("Masse d'armes", new De(1,6), 1, new Substantif("épée longue", new Feminin())),
            new ArmeDistance("Fronde", new De(1,4), 6, new Substantif("épée longue", new Feminin())),
            new ArmeDistance("Arbalète légère", new De(1,8), 16, new Substantif("épée longue", new Feminin())),
            new ArmeDistance("Arc court", new De(1,6), 16, new Substantif("baton", new Masculin())),
            new ArmeGuerre("épée à deux mains",  new De (2,6), 1, new Substantif("épée longue", new Feminin())),
