...
public class CoordonneesItem extends Coordonnees{
    ...
    private static final List<Item> m_items = List.of(
            new ArmeCourante("Baton", new De(1,6), 1),
            new ArmeGuerre("Rapière", new De(1,4), 1),
            new ArmeGuerre("épée longue", new De(1,4), 2),
            new ArmeCourante("Masse d'armes", new De(1,6), 1),
            new ArmeDistance("Fronde", new De(1,4), 6),
            new ArmeDistance("Arbalète légère", new De(1,8), 16),
            new ArmeDistance("Arc court", new De(1,6), 16),
